...
class RavenHandlerTest extends TestCase
{
    ...
    public function testDebug()
    {
        ...
        $record = $this->getRecord(Logger::DEBUG, 'A composer debug message');
    ...
    public function testWarning()
    {
        ...
        $record = $this->getRecord(Logger::WARNING, 'A composer warning message');
        $handler->handle($record);
    ...
    public function testTag()
    {
        ...
        $tags = array(1, 2, 'foo');
        $record = $this->getRecord(Logger::INFO, 'composer', array('tags' => $tags));
        $handler->handle($record);
    ...
    public function testExtraParameters()
    {
        ...
        $record = $this->getRecord(Logger::INFO, 'composer', array('checksum' => $checksum, 'release' => $release));
        $handler->handle($record);
    ...
    public function testUserContext()
    {
        ...
        $recordWithNoContext = $this->getRecord(Logger::INFO, 'composer with default user context');
        ...
        $recordWithContext = $this->getRecord(Logger::INFO, 'composer', array('user' => $user));
