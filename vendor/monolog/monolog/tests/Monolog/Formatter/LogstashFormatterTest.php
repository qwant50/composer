...
class LogstashFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $formatter = new LogstashFormatter('composer', 'hostname');
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
        ...
        $this->assertEquals('composer', $message['@type']);
    ...
    {
        $formatter = new LogstashFormatter('composer');
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
            ...
            'datetime' => new \DateTime("@0"),
            'extra' => array('file' => 'composer', 'line' => 14),
            'message' => 'log',
        );

        $message = json_decode($formatter->format($record), true);

        $this->assertEquals('composer', $message['@fields']['file']);
    ...
    public function testFormatWithContext()
    {
        ...
        $formatter = new LogstashFormatter('composer', null, null, 'CTX');
        $message = json_decode($formatter->format($record), true);
    ...
    public function testFormatWithExtra()
    {
        ...
        // Test with extraPrefix
        $formatter = new LogstashFormatter('composer', null, 'EXT');
        $message = json_decode($formatter->format($record), true);
    ...
    {
        $formatter = new LogstashFormatter('app', 'composer');
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
    ...
    {
        $formatter = new LogstashFormatter('composer', 'hostname', null, 'ctxt_', LogstashFormatter::V1);
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
    ...
    {
        $formatter = new LogstashFormatter('composer', null, null, 'ctxt_', LogstashFormatter::V1);
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
        ...
        $this->assertEquals('composer', $message['file']);
    ...
    public function testFormatWithContextV1()
    {
        ...
        // Test with extraPrefix
        $formatter = new LogstashFormatter('composer', null, null, 'CTX', LogstashFormatter::V1);
        $message = json_decode($formatter->format($record), true);
    ...
    public function testFormatWithExtraV1()
    {
        ...
        // Test with extraPrefix
        $formatter = new LogstashFormatter('composer', null, 'EXT', 'ctxt_', LogstashFormatter::V1);
        $message = json_decode($formatter->format($record), true);
    ...
    {
        $formatter = new LogstashFormatter('app', 'composer', null, 'ctxt_', LogstashFormatter::V1);
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
